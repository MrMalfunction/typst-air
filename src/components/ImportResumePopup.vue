    ...
    <q-card style="width: 500px; max-width: 80vw;">
      ...
      <q-card-section>
        ...
        <div class="text-caption q-mt-sm">
          We will try our best to import your resume. Max file size: 200KB.
        </div>
        <div class="text-caption text-red q-mt-sm">
          We will use an AI provider to parse your resume, but your information is not stored on any server.
        </div>
      </q-card-section>
